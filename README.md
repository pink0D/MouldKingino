# Overview
**MouldKingino** is an Arduino library for controlling Mould King Power Modules. [NimBLE-Arduino](https://github.com/h2zero/NimBLE-Arduino) library is utilized for wireless communication.
