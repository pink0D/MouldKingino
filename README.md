...
| **Mould King 3.0 Vehicle Module** <br/> <img width="50" alt="MK logo" src="https://github.com/user-attachments/assets/7d436cb4-5eb3-4f68-9fc1-404786991aca" /> | <img width="150" alt="mk30" src="https://github.com/user-attachments/assets/6b7b0a43-a9db-46d4-92b4-59d2a3536246" /> | :white_check_mark: Supported | 2x built-in motors: CH1 (MOTOR_A) steering, CH2 (MOTOR_B) drive. CH3 and CH4 present in protocol but ignored by module |
